					...
					<div class="sign">
						<div class="sign__content">
							...
							<form action="#" class="sign__form">
								...
								<span class="sign__text">Don't have an account? <a href="{{ route("client.register")}}">Sign up!</a></span>

								<span class="sign__text"><a href="{{ route("client.forgot")}}">Forgot password?</a></span>
							</form>
