...
<div class="col-12">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb__item breadcrumb__item--active">{{$artist->name}}</li>
					</ul>
				</div>
  ...
  <button type="submit" class="hero__btn hero__btn--danger" onclick="return confirm('Are You Sure? You Want To Delete')"  style="font-family: Inter, Bangla524, sans-serif;background:#5e0000">Delete This Artist</button>
        ...
        <div class="article article--page">
            ...
            <!-- end article content -->
				...
				<div class="col-12">
				    <div class="main__title main__title--page">
						<h1>Albums From {{ $artist->name }}</h1>
					</div>
				    <div class="hero__btns">
								<a href="{{ route("admin.albums.create") }}?artist={{$artist->id}}" class="hero__btn hero__btn--green" style="font-family: Inter, Bangla524, sans-serif;">Create Album</a>
...
@endforeach
				...
				<div class="col-12">
					<div class="main__title main__title--page">
						<h1>Songs List of {{ $artist->name }}</h1>
					</div>
				</div>
    <div class="hero__btns">
								<a href="{{ route("admin.songs.create") }}?artist={{$artist->id}}" class="hero__btn hero__btn--green">Upload Song</a>
