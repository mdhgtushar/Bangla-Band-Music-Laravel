...
<div class="col-12">
					<ul class="breadcrumb">
						...
						<li class="breadcrumb__item breadcrumb__item--active">Upload Song</li>
					</ul>
				</div>
				<div class="col-12">
				...
				<div class="col-12 col-lg-7 col-xl-8">
                    ...
                    @endif
					<form  action="{{ route("admin.songs") }}" method="POST" enctype="multipart/form-data" class="sign__form sign__form--contacts">
					    @csrf
						<div class="row">
							<div class="col-12">
								<div class="sign__group">
									<input type="text" required name="title" class="sign__input" placeholder="Title">
								</div>
							</div>
							...
							<div class="col-12 col-md-6">
                                ...
                                <option value="{{ $album->id }}" {{(isset($_GET["album"]) && ($_GET["album"] == $album->id)) ? "selected" : "" }}  >{{ $album->name }} </option>  
                                @endforeach
									    </select>
								</div>
							</div>
							<div class="col-12">
								<div class="sign__group">
									<textarea name="lyric" class="sign__textarea" placeholder="Song Lyric (optional)"></textarea>
								</div>
							</div>
