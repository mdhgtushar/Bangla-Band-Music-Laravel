    ...
    <div class="col-12">
        <div class="main__title main__title--page">
				    ...
				    <div class="hero__btns">
								<a href="{{ route("admin.albums.edit", $album->id) }}" class="hero__btn hero__btn--green" style="font-family: Inter, Bangla524, sans-serif;">Edit This Album</a>
  ...
  <button type="submit" class="hero__btn hero__btn--danger" onclick="return confirm('Are You Sure? You Want To Delete')"  style="font-family: Inter, Bangla524, sans-serif;background:#5e0000">Delete This Album</button>
        ...
        <div class="article article--page">
            ...
            <!-- end article content -->
				...
				<div class="col-12">
					<div class="main__title main__title--page">
						<h1>Songs List of {{ $album->name }}</h1>
					</div>
				</div>
<div class="col-12">
    <div class="hero__btns">
								<a href="{{ route("admin.songs.create") }}?artist={{$album->artist_id}}&album={{$album->id}}" class="hero__btn hero__btn--green">Upload Song On This Album</a>
