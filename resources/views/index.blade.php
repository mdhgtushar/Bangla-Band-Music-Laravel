   ...
   <div class="col-12">
      <div class="main__title">
         <h2>
            ...
            <a href="{{ route("artists") }}">Top Bands </a>
         </h2>
    ...
    <div class="col-12">
       <div class="main__carousel-wrap">
          <div
             class="main__carousel main__carousel--artists owl-carousel"
             id="artists"
             >
   ...
   <div class="col-12">
      <div class="main__title">
         <h2>
            ...
            <a href="{{ route("albums") }}">Hit Albums</a>
         </h2>
          ...
          <div class="col-12">
            <div class="main__title">
               <h2>
                  ...
                  <a href="{{ route("songs") }}" class="main__link">See all <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M17.92,11.62a1,1,0,0,0-.21-.33l-5-5a1,1,0,0,0-1.42,1.42L14.59,11H7a1,1,0,0,0,0,2h7.59l-3.3,3.29a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0l5-5a1,1,0,0,0,.21-.33A1,1,0,0,0,17.92,11.62Z"></path></svg></a>
...
<br>
                ...
                <li class="single-item">
                  <a data-playlist="" data-lyric='{{ $song->lyric }}' data-title="{{ $song->title }}" data-artist="{{ isset($song->artist->name) ? $song->artist->name : "unknown" }}" data-img="{{ asset("simages/$song->image") }}" href="{{ asset("audios/$song->audio") }}" class="single-item__cover">
