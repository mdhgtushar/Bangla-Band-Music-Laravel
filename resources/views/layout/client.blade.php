...
<div class="header__action ">
				...
				<div class="header__action header__action--signin">
					<a class="header__action-btn" href="{{ route("client.login")}}">
						<span>Sign in</span>
      ...
      <div class="sidebar">
         ...
         <ul class="sidebar__nav">
            <li class="sidebar__nav-item">
               <a
                  href="{{ route("home") }}"
                  class="sidebar__nav-link sidebar__nav-link{{ request()->routeIs('home') ? '--active' : '' }}"
                  >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                     <path
            ...
            <li class="sidebar__nav-item">
               <a href="{{ route("artists") }}" class="sidebar__nav-link sidebar__nav-link{{ request()->routeIs('artists', 'artists.*') ? '--active' : '' }}"
                  >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                     <path
            ...
            <li class="sidebar__nav-item">
               <a href="{{ route("albums") }}" class="sidebar__nav-link sidebar__nav-link{{ request()->routeIs('albums','albums.*') ? '--active' : '' }}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.65,2.24a1,1,0,0,0-.8-.23l-13,2A1,1,0,0,0,7,5V15.35A3.45,3.45,0,0,0,5.5,15,3.5,3.5,0,1,0,9,18.5V10.86L20,9.17v4.18A3.45,3.45,0,0,0,18.5,13,3.5,3.5,0,1,0,22,16.5V3A1,1,0,0,0,21.65,2.24ZM5.5,20A1.5,1.5,0,1,1,7,18.5,1.5,1.5,0,0,1,5.5,20Zm13-2A1.5,1.5,0,1,1,20,16.5,1.5,1.5,0,0,1,18.5,18ZM20,7.14,9,8.83v-3L20,4.17Z"></path></svg>
                   <span>Albums</span></a>
            </li>
            <li class="sidebar__nav-item">
               <a href="{{ route("songs") }}" class="sidebar__nav-link sidebar__nav-link{{ request()->routeIs('songs','songs.*') ? '--active' : '' }}">
	...
	<div class="player" onclick="console.log(this)">
		<div class="player__cover">
			<img src="{{asset("site_images/play_first.png")}}" alt="">
		</div>
